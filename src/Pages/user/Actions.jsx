...
const Actions = () => {
    ...
    return (
        <div className="relative cursor-pointer px-3 py-2">
            <HiDotsVertical className="" onClick={toggleMenu} />
            {isOpen && (
                <div className="absolute top-0 -left-24 bg-white border p-3 flex flex-col justify-center items-start gap-1 rounded-md shadow-md">
