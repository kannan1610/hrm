...
const ActionMenu = () => {
    ...
    return (
        <div className="relative me-1 flex">
            ...
            {isOpen && (
                <div className=" absolute right-0 bottom-0.5 flex font-medium px-1  ">
                    <div className=" px-1 w-20 bg-white shadow-2xl rounded-lg  ">
                        <div className="flex gap-2 py-1 hover:bg-white- " onClick={()=>optionClick("Edit")}>
                        <HiOutlinePencil size={15}/>  <button>Edit</button>
                        </div>
                        <div className="flex gap-2 py-1 hover:bg-white" onClick={()=>optionClick("Delete")}>
                            <RiDeleteBinLine size={15} /><button>Delete</button> 
                        </div>
                        <div className="flex gap-2 py-1 hover:bg-white" onClick={()=>optionClick("View")}>
