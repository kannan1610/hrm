...
//       <div className=" p-5 sm:ms-5 md:ms-4 rounded-lg  w-10/12 h-auto min-h-[7rem] border-l-4 border-l-purple-500 " style={{  backgroundColor: '#e6e6e6', borderColor: '#003366' }}>
...
//         <div className=" p-5 sm:ms-5 md:ms-4 rounded-lg  w-10/12 h-auto min-h-[7rem] border-l-4 " style={{ backgroundColor: '#ffece6', borderColor: '#ff9d80' }}>
//           <div className="flex items-center">
...
//         <div className="p-5 sm:ms-5 md:ms-4 rounded-lg  w-10/12 h-auto min-h-[7rem] border-l-4 " style={{ backgroundColor: '#f4fafd', borderColor: '#00bfff' }}>
//           <div className="flex items-center">
...
//         <div className="p-5 sm:ms-5 md:ms-4 rounded-lg  w-10/12 h-auto min-h-[7rem] border-l-4 " style={{ backgroundColor: '#c4ede0', borderColor: '#36b089' }}>
//           <div className="flex items-center">
